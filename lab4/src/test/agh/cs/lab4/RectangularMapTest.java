...
public class RectangularMapTest {
    ...
    public static Animal a,b,c,d,e, f;
    public static IWorldMap map;

    @Before
    public void setUp() {
        map = new RectangularMap(10, 8);
        a = new Animal(map);
    ...
    public void canMoveToTest() {
        ...
        Assert.assertFalse(map.canMoveTo(new Vector2d(10,7)));
    }
    ...
    public void placeTest() {
        ...
        Assert.assertFalse(map.place(d));
        Assert.assertFalse(map.place(e));
        map.place(c);
    ...
    public void runTest() {
        ...
        Assert.assertEquals(a.getPosition(), new Vector2d(0,2));
    ...
    public void isOccupiedTest() {
        ...
        Assert.assertFalse(map.isOccupied(f.getPosition()));
        map.place(c);
    ...
    public void objectAtTest() {
        ...
        map.place(c);
        Assert.assertEquals(c, map.objectAt(new Vector2d(3,3)));
    }
}
