...
public class OptionsParserTest {
    ...
    public void testStr() {
        ...
        String[] t2Moves = new String[]{"forward", "f", "f", "forward", "left"};
        String[] t3Moves = new String[]{"right", "b", "backward", "b", "b", "r"};
    ...
    public void parserTest(){
        ...
        //Assert.assertThrows(IllegalArgumentException.class, () -> OptionsParser.parse(t4)); //junit5
    }
}
